...
GET     host/realtime/:auth?start=0&end=20              第1~20筆清單
GET     host/realtime/:auth?start=0&end=20&factory=001  列出 001 工廠相關的info清單
GET     host/realtime/:auth?start=0&end=20&factory=001&type=work&id=s00032     搜尋001工廠中工單編號 s0032 相關的info清單
...
GET     host/machine/:auth?start=0&end=20           第1~20筆清單
...
GET     host/workorder/:auth?start=0&end=20    第1~20筆清單
